(() => {
  ...
  const ensureHomeButtonStyle = () => {
    ...
    style.textContent = `
      ...
      .hero-actions .button.primary[href*="ai.aoussgabash.com"]{position:relative!important;isolation:isolate!important;overflow:hidden!important;color:#f4f7fb!important;border:1px solid rgba(190,163,105,.38)!important;background:linear-gradient(90deg,#856a35 0%,#9b7b3f 24%,#3d6581 65%,#294d6d 100%)!important;box-shadow:0 10px 24px rgba(3,20,38,.24),0 4px 14px rgba(133,106,53,.10),inset 0 1px 0 rgba(255,255,255,.08)!important;text-shadow:0 1px 2px rgba(2,10,20,.38)!important;transition:transform .22s ease,box-shadow .22s ease,filter .22s ease!important}
      .hero-actions .button.primary[href*="ai.aoussgabash.com"]::before{content:"";position:absolute;inset:0;z-index:-1;background:linear-gradient(115deg,rgba(255,255,255,.045),transparent 38%,transparent 72%,rgba(255,255,255,.025));pointer-events:none}
      .hero-actions .button.primary[href*="ai.aoussgabash.com"]:hover,.hero-actions .button.primary[href*="ai.aoussgabash.com"]:focus-visible{transform:translateY(-2px)!important;filter:saturate(1.01) brightness(1.02)!important;border-color:rgba(207,181,123,.52)!important;box-shadow:0 14px 30px rgba(3,20,38,.28),0 6px 18px rgba(133,106,53,.13),0 0 0 2px rgba(155,123,63,.05)!important;outline:none!important}
