(() => {
  ...
  unifiedStyles.textContent = `
    ...
    #books .published-book-unified{position:relative;overflow:hidden;display:flex;flex-direction:column;min-height:100%;padding:28px;border:1px solid rgba(14,116,144,.34)!important;border-top:4px solid #0f4c75!important;border-radius:20px!important;background:linear-gradient(155deg,#ffffff 0%,#f1f8fc 58%,#e7f3fa 100%)!important;box-shadow:0 20px 48px rgba(15,76,117,.15)!important}
    ...
    #books .published-book-toggle{width:100%;min-height:50px;margin-top:12px;border-color:#0f4c75;background:#0f4c75;color:#fff;box-shadow:0 8px 20px rgba(15,76,117,.18);transition:transform .18s ease,background .18s ease,box-shadow .18s ease}
    ...
    #books .book-meta{min-height:220px;border-color:rgba(15,76,117,.2);background:rgba(255,255,255,.82);box-shadow:inset 0 1px 0 rgba(255,255,255,.85)}
    ...
    #books .published-book-action{margin-top:auto;padding-top:20px}
    #books .published-book-action .button{width:100%;min-height:58px;border-radius:13px;box-shadow:0 12px 28px rgba(37,99,235,.2)}
    ...
    @media(max-width:900px) and (min-width:681px){#books .published-book-unified h3{min-height:132px}#books .book-meta{min-height:205px}}
    @media(max-width:680px){#books .published-book-unified{padding:20px}#books .published-book-unified>span,#books .published-book-unified h3,#books .book-meta{min-height:0}#books .published-book-unified h3{font-size:1.2rem}#books .published-book-frame{aspect-ratio:3/4}#books .published-book-frame img{padding:10px}#books .upcoming-books-divider{gap:9px}#books .upcoming-books-divider strong{font-size:.72rem;white-space:normal}}
  `;
