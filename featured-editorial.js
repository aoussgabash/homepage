(() => {
  ...
  card.innerHTML = `
    ...
    <div class="featured-editorial-copy">
      ...
      <p>A curated scientific volume presenting seven peer-reviewed contributions on sustainable energy systems, battery storage, renewable-energy integration, real-time optimal power flow, and the evolution of the C+++ Framework. The volume includes an editorial preface prepared by Dr.-Ing. Aouss Gabash.</p>
      <p class="featured-ar" lang="ar" dir="rtl">مجموعة علمية مختارة تضم سبعة أبحاث محكّمة حول أنظمة الطاقة المستدامة، وتخزين الطاقة، ودمج الطاقات المتجددة، وتدفق الاستطاعة الأمثل الآني، وتطور إطار C+++، وتتضمن مقدمة تحريرية أعدّها الدكتور المهندس أوس غباش.</p>
  ...
  styles.textContent = `
    ...
    @media(max-width:520px){.featured-editorial-work{padding:18px;border-radius:20px}.featured-actions{flex-direction:column}.featured-actions .button{width:100%}}
  `;
